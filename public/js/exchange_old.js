$(document).ready(function () {
    ...
    if($('.currency-exchange-wallet-sel').length == 0) return false;
    ...
    var amount = $('.input-amount'); //moved
    var badge = $('.exchange-rate-badge') //moved
    ...
    function updateDeltas() {
        ...
        if (selC == 0) {
            ...
            deltaTo =  formatMoney(getValueFromCurrencyToCurrency(amaV, firstC.slice(0, 3), secC.slice(0, 3)))
        ...
        var summaryText = 'The new balance of '+ fromW +' will be '+  getSymbolFromCurrency(firstC.toString()) + formatMoney(differenceFrom)
