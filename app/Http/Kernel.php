...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\XSSProtection::class, // Very important function to get XSS scripts out of forms.
    ];
    ...
    protected $routeMiddleware = [
        ...
        'checkistokenholder' => \App\Http\Middleware\CheckIsTokenholder::class,
    ];
}
