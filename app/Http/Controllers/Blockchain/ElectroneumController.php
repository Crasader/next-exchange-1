...
use App\Http\Controllers\Blockchain\RPCController as RPCController;

class ElectroneumController extends Controller
{
    private $url;
    private $client;
    private $ip;
     ...
     */
    function __construct ($ip = '212.129.45.60', $port = '26968', $protocol = 'http', $user = null, $password = null){
        $this->ip = $ip;
        $this->port = $port;
        ...
        $this->client = new RPCController($this->url, $this->user, $this->password);
    }
    ...
    */
    ...
    public function getWallet(){
        ...
        $electroneum = new ElectroneumController('212.129.45.60','26968');
        return view('dev.electroneum', compact('electroneum'));
