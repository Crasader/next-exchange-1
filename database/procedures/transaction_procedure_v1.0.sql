...
PROCEDURE next_exchange.order_execute(IN param_order_id INTEGER, OUT return_data TEXT)
READS SQL DATA
BEGIN
    ...
    SET to_execute = ord_amount - amount_executed;
        ...
        DECLARE execute_now DECIMAL(20, 9);
            ...
            find_match_loop: LOOP
                ...
                SELECT *
                FROM orders
                WHERE order_id = match_id FOR UPDATE;
                ...
                THEN
                    ...
                    SET @wallet_blalnce = (SELECT amount
                                           FROM wallet
                                           WHERE id = @wallet_id);
